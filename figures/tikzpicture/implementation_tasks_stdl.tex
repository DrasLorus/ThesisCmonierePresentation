...
\begin{tikzpicture} [->,
  ...
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[cpp]|   {FIR} & |[cpp]|   {Détecteur} & |[mat]|   {Sync. Temp.} & |[mat]|   {Sync. Freq.} & |[mat]|   {Sync. Phase} & |[mat]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[cpp]|   {Détecteur} & |[mat]|   {Sync. Temp.} & |[mat]|   {Sync. Freq.} & |[mat]|   {Sync. Phase} & |[mat]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[cpp]|   {Détecteur} & |[cpp]|   {Sync. Temp.} & |[cpp]|   {Sync. Freq.} & |[mat]|   {Sync. Phase} & |[mat]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[rfnoc]| {Détecteur} & |[cpp]|   {Sync. Temp.} & |[cpp]|   {Sync. Freq.} & |[mat]|   {Sync. Phase} & |[mat]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[rfnoc]| {Détecteur} & |[rfnoc]| {Sync. Temp.} & |[rfnoc]| {Sync. Freq.} & |[mat]|   {Sync. Phase} & |[mat]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[rfnoc]| {Détecteur} & |[rfnoc]| {Sync. Temp.} & |[rfnoc]| {Sync. Freq.} & |[cpp]|   {Sync. Phase} & |[cpp]|   {Décodeur NB-LDPC} & |[txt]| {}  \\
  |[txt]| {} & |[rfnoc]| {Tâches RF} & |[rfnoc]| {FIR} & |[rfnoc]| {Détecteur} & |[rfnoc]| {Sync. Temp.} & |[rfnoc]| {Sync. Freq.} & |[rfnoc]| {Sync. Phase} & |[rfnoc]| {Décodeur NB-LDPC} & |[txt]| {}  \\
  };
  ...
  \node [matrix, draw = black, thick,
    ...
    \node [rfnoc, align = center, minimum size = 3 cm] (rfnoc_l) {IP\\Matériel};
    \node [cpp,   align = center, minimum size = 3 cm, right = 2 cm of rfnoc_l] (cpp_l) {Logiciel\\(C/\cpp{})};
  \node [mat,   align = center, minimum size = 3 cm, right = 2 cm of cpp_l] {MATLAB\\Octave};\\
  \node [draw = none, minimum size = 1cm] {}; \\
  \node[usrp, align = center, minimum size = 3 cm, anchor = north west] (usrp_l) {Embarqué dans\\le module SdR};
  \node[pc,   align = center, minimum size = 3 cm, right = 2 cm of usrp_l] (pc_l) {Traiter\\par l'hôte};\\
  };
