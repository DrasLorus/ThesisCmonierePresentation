...
\begin{tikzpicture} [-latex,
  ...
  \node [main node,
    ...
    minimum height = 1.5cm,
    % minimum width = 6cm,
  ] (demod) at (synch -| mod) {Démodulation};
  ...
  \draw (synch.west)   -> (demod.east);
  \draw (demod.west)   -> (chandec.east);
  \draw (chandec.west) -> (mp.east);

  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

  \draw [dashed, line width = 3pt, -] (m |- chan) -- (adc |- chan);
  \node [] at (mod |- chan.north) {\textbf{Émission}};
  \node [] at (mod |- chan.south) {\textbf{Réception}};
