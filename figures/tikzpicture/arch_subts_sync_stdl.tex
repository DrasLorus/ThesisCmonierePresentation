...
\begin{tikzpicture} [->,
  ...
  \node[main node,
    minimum width = 2.5cm,
    anchor = north west,
  ] (mult1) at ($(minus.east) + (1.25, -3.)$) {$\times  p_{k + q - 1}(q - 1)$};
  ...
  node [pos = .6, anchor=north east] (ankh) {$d^{\textcolor{blue}{\bm{\omega}}}_n$}; %  == (y(n) - y(n - q)e^{j{\textcolor{blue}{\bm{\omega}}}} ) e^{-j \frac{{\textcolor{blue}{\bm{\omega}}} n}{q}}
