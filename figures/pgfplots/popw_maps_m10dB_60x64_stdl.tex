\documentclass[tikz,margin=3pt,dvipsnames,rgb]{standalone}
...
\begin{tikzpicture}[
  ...
  \foreach \i/\ib in {1/1, 2/3, 3/5} {
      \foreach \j/\jb in {1/1, 2/3, 3/5} {
            ...
            minimum size = 2 cm] (v\i\j) at (\ib, \jb) {$\lookupraw{\i}{\j}$};
        }
    }

    \node [red, thick, inner sep = 0pt, draw, fit={(v22) (v33)}] (fp) {};
    \node [red, anchor = south] at (fp.south) {Functioning limit};
