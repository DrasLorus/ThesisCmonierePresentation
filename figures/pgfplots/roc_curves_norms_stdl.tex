...
\begin{tikzpicture}[
  ...
  \begin{loglogaxis}
    ...
    \addplot[ dashed, color=Orange, mark = o, mark options = {solid}, thick, forget plot ]
    table [ x=Pfa_LINF, y=Pmd_LINF ] {\fromRoot{data/norms_data_po5_raw_60x64.dat}};
    ...
    table [ x=Pfa_LINF, y=Pmd_LINF ] {\fromRoot{data/norms_data_sync_raw_60x64.dat}};
    ...
    node [pos = -.75, ] {reference};

    \addplot[ color=red!80, mark = *, thick, mark size = 2pt, forget plot ]
    coordinates {(1e-6, 1e-4)};
    \node [anchor = west, red!80, align=left] at (11e-7, 1e-4) {Functioning\\point};
