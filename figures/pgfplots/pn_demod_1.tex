...
\begin{tikzpicture}[
  ...
  \begin{axis} [
    ...
    \addplot [Chartreuse4] coordinates {
        (0.5, {ifthenelsefpu({(0 == 1)}, 4, 0)})
        (1.5, {ifthenelsefpu({(1 == 1)}, 4, 0)})
        (2.5, {ifthenelsefpu({(2 == 1)}, 4, 0)})
        (3.5, {ifthenelsefpu({(3 == 1)}, 4, 0)})};

    \addplot [Red] coordinates {(1 + .5, 0) (1 + .5, 4)};
    \addplot [Red, mark = *] coordinates {(1 + .5, 4)};
