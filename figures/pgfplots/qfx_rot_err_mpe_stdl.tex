...
\begin{tikzpicture}[
  ...
  \begin{axis}
    ...
    table [ x=id, x expr = (\thisrow{id} + 1), y=mpe4 ] {\fromRoot{data/qfx_rot_test_q64.dat}};

    \addplot[ dashed, color=RoyalBlue!60, mark = diamond, mark options = {solid}, thick,]
    table [ x=id, x expr = (\thisrow{id} + 1), y=mpe4 ] {\fromRoot{data/qfx_rot_test_q256.dat}};

    \addplot[ solid, color=Orange, mark = *, mark options = {solid}, thick, ]
    table [ x=id, x expr = (\thisrow{id} + 1),  y=mpe8 ] {\fromRoot{data/qfx_rot_test_q64.dat}};

    \addplot[ solid, color=RoyalBlue, mark = diamond*, mark options = {solid}, thick, ]
    table [ x=id, x expr = (\thisrow{id} + 1),  y=mpe8 ] {\fromRoot{data/qfx_rot_test_q256.dat}};
