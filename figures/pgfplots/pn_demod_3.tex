...
\begin{tikzpicture}[
  ...
  \begin{axis} [
    ...
    \addplot [Chartreuse4] coordinates {
        (0.5, {ifthenelsefpu({(0 == 3)}, 4, 0)})
        (1.5, {ifthenelsefpu({(1 == 3)}, 4, 0)})
        (2.5, {ifthenelsefpu({(2 == 3)}, 4, 0)})
        (3.5, {ifthenelsefpu({(3 == 3)}, 4, 0)})};

    \addplot [Red] coordinates {(3 + .5, 0) (3 + .5, 4)};
    \addplot [Red, mark = *] coordinates {(3 + .5, 4)};
